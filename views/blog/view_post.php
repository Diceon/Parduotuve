<?php if (isset($this->data['forum_post']) && sizeof($this->data['forum_post']) > 0) { ?>
    <div class="position-relative col-xl-8 col-lg-10 col-md-10 col-sm-12 mx-auto my-5 py-5 shadow">
        ...
        <a href="/parduotuve/blog/<?php echo mb_strtolower($this->data['forum_post']['forum']); ?>" class="position-absolute m-1 forum-back"><button type="button" class="btn btn-sm btn-dark">Back</button></a>
    </div>
<?php } else { ?>
    <h1 class="text-center my-5">No such post</h1>
<?php } ?>
